...
def main():
    data_folder = "../data/"
    model_dir = "./model_bert_base_cased/"
    transformer_name = "distilbert-base-cased"

    # load corpus containing training, test and dev data and if CSV has a header, you can skip it
    corpus: Corpus = CSVClassificationCorpus(data_folder, label_type="status",
    ...
    trainer.fine_tune(model_dir, learning_rate=3e-5, mini_batch_size=16, max_epochs=4,
